...
//use the same code in different places
...
const listWidget = (() => {
  ...
  return {
    ...
    apiKey: key, // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
    ...
    updateUIWorking: () => {
      //let - block scope, save us extra work
      //var - not create block scope
